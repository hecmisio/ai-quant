"""Base interface and shared contract checks for trading strategies."""
...
class BaseStrategy(ABC):
    ...
    def run(self, data: pd.DataFrame) -> pd.DataFrame:
        """Execute the strategy and enforce the shared output contract."""
    ...
    def validate_position_output(self, positioned: pd.DataFrame) -> None:
        ...
        numeric_positions = pd.to_numeric(
            positioned[self.TARGET_POSITION_COLUMN], errors="coerce"
        )
